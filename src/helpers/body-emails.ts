                       ...
                       <table cellpadding="0" cellspacing="0" class="es-right" align="right" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:right">
                         <tr style="border-collapse:collapse">
                          <td align="left" style="padding:0;Margin:0;width:274px">
                           <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                             <tr style="border-collapse:collapse">
                              <td align="right" style="padding:10px;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:40px;color:#ffffff;font-size:20px"><strong>${
                                names + " " + lastnames
                              }</strong></p></td>
                             </tr>
                           </table></td>
                         ...
                         <tr style="border-collapse:collapse">
                          <td class="es-m-p20b" align="left" style="padding:0;Margin:0;width:270px">
                           <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                             ...
                             <tr style="border-collapse:collapse">
                              <td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#A0A7AC;font-size:14px"><strong>Fecha:</strong>&nbsp;${orderDate}<br><strong style="text-align:center">Cantidad de productos:</strong><span style="text-align:center"> ${
      products.length
    }</span></p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#A0A7AC;font-size:14px"><strong>Método de pago:</strong> ${
      chosenPayment.name
                         ...
                         <tr style="border-collapse:collapse">
                          <td align="left" style="padding:0;Margin:0;width:270px">
                           <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                             ...
                             <tr style="border-collapse:collapse">
                              <td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#A0A7AC;font-size:14px"><strong>Departamento: </strong>Cundinamarca<br><strong>Ciudad/Municipio:</strong>&nbsp;${
                                address.municipality
                              }<br><strong>Dirección:</strong>&nbsp;${
      address.address
    }</p><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#A0A7AC;font-size:14px"><b>Teléfono: </b>${
      address.phone
    }</p></td>
                             </tr>
                           </table></td>
...
export const notifyOrderPaidConsumer = (user: User) => {
  ...
  return {
    from: '"Confirmación de pago" <proyectospcudec@gmail.com>',
...
export const notifyOrderToTransport = (user: User) => {
  ...
  return {
    ...
    subject:
      "¡Se te ha asignado un nuevo pedido para recoger y entregar 🚚🥑🚛🍒!",
    html: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office">
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="right" class="esd-block-text es-p10">
                                                                                            <p style="font-size: 20px; color: #2d281e; font-family: lato, &quot;helvetica neue&quot;, helvetica, arial, sans-serif; line-height: 200%;"><strong>${
                                                                                              names +
                                                                                              " " +
                                                                                              lastnames
                                                                                            }</strong></p>
...
export const notifyOrderOnTheWayConsumer = (user: User, tariff: number) => {
  const { uid, names, lastnames } = user;
  return {
    from: '"Pedido en camino" <proyectospcudec@gmail.com>',
    subject: "¡Tu pedido se encuentra en camino! 🚚🍇🚨🍑",
    html: `<!DOCTYPE html
    PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office"
    style="width:100%;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-header-body" cellspacing="0" cellpadding="0" align="center"
                                    ...
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#f8f8f8;width:600px">
                                    <tr style="border-collapse:collapse">
                                        <td align="left" bgcolor="#058d38"
                                            style="padding:15px;Margin:0;background-color:#058d38">
                                            <!--[if mso]><table style="width:570px" cellpadding="0" cellspacing="0"><tr><td style="width:276px" valign="top"><![endif]-->
                                            <table cellpadding="0" cellspacing="0" class="es-left" align="left"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
                                                <tr style="border-collapse:collapse">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <div>
                                                                        <h2
                                                                            style="Margin:0;line-height:31px;mso-line-height-rule:exactly;font-family:Arial, sans-serif;font-size:26px;font-style:normal;font-weight:normal;color:#242424">
                                                                            <b>¡TU PEDIDO ESTÁ EN CAMINO!</b></h2>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:20px;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#A0A7AC;font-size:14px">
                                                                        <font color="#242424">Hola
                                                                            ${names}, queremos informarte
                                                                            que tu pedido acaba de cambiar de estado a
                                                                        </font><span style="color:#242424"><span
                                                                                style="background-color:#D3D3D3">"En
                                                                                camino"</span></span>
                                                                        <font color="#242424">. Lo cual significa que
                                                                            muy pronto lo tendrás en tus manos,
                                                                            adicionalmente, de acuerdo a las
                                                                            especificaciones y lugar de destino del
                                                                            pedido, la tarifa de envío que deberás
                                                                            pagarle al transportador será de:</font>
                                                                        <br><br>
                                                                    </p>
                                                                    <h1
                                                                        style="Margin:0;line-height:31px;mso-line-height-rule:exactly;font-family:'noticia text', georgia, 'times new roman', serif;font-size:26px;font-style:normal;font-weight:normal;color:#ff8c00">
                                                                        <strong>$${tariff} COP</strong></h1>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#A0A7AC;font-size:14px">
                                                                        <br></p>
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:21px;color:#000000;font-size:14px;text-align:center">
                                                                        Toda la información adicional la
                                                                        encontrarás&nbsp;en la sección de tu perfil
                                                                        denominada<br>"Mis pedidos", no te pierdas de
                                                                        ningún detalle ¡Adelante!</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    style="Margin:0;padding-left:10px;padding-right:10px;padding-top:15px;padding-bottom:15px">
                                                                    <span class="es-button-border"
                                                                        style="border-style:solid;border-color:#2cb543;background:#999999;border-width:0px;display:inline-block;border-radius:20px;width:auto"><a
                                                                            href="https://bdproyectospc.web.app/#/perfil-consumidor/mis-pedidos/${uid}"
                                                                            class="es-button es-button-1"
                                                                            target="_blank"
                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#ffffff;font-size:16px;border-style:solid;border-color:#999999;border-width:10px 35px;display:inline-block;background:#999999;border-radius:20px;font-family:'lucida sans unicode', 'lucida grande', sans-serif;font-weight:normal;font-style:normal;line-height:19px;width:auto;text-align:center">Revisar
                                                                            mi pedido</a></span></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0px"><img
                                                                        class="adapt-img"
                                                                        src="https://wjmjag.stripocdn.email/content/guids/CABINET_9eaf91494aede89a83719bd892ab1557/images/a.png"
                                                                        alt
                                                                        style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                        width="600"></td>
                                                            </tr>
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-footer-body" cellspacing="0" cellpadding="0" align="center"
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td align="left" bgcolor="#058D38"
                                            style="padding:20px;Margin:0;background-color:#058d38">
                                            <table width="100%" cellspacing="0" cellpadding="0"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr style="border-collapse:collapse">
                                                    <td valign="top" align="center"
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:17px;color:#ffffff;font-size:14px">
                                                                        <strong><span>Universidad de
                                                                                Cundinamarca<br>Laura Tatiana Ramos
                                                                                Villanueva &amp; Johann Nicolás Nieto
                                                                                Cárdenas<br><a target="_blank"
                                                                                    href="mailto:proyectospcudec@gmail.com"
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#ffffff;font-size:14px;line-height:17px">proyectospcudec@gmail.com</a></span></strong>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Arial, sans-serif;line-height:38px;color:#cccccc;font-size:25px">
                                                                        NOS UNE EL AMOR POR EL&nbsp;<br><strong>CAMPO
                                                                            CUNDINAMARQUÉS</strong></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
...
export const notifyOrderOnTheWayCarrier = (user: User, order: Order) => {
  const { names, lastnames } = user;
  const { id, tariff } = order;
  return {
    from: '"Tarifa de envío calculada" <proyectospcudec@gmail.com>',
    subject: `¡El pedido N° ${id?.slice(
      0,
      8
    )} ya tiene tarifa calculada! 🚚💸🍒`,
    html: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office">
                                                                        ...
                                                                        <table width="100%" cellspacing="0" cellpadding="0" style="border-radius: 3px; border-collapse: separate;">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p30t es-p15b" align="center">
                                                                                        <div class="esd-text">
                                                                                            <h2 style="color: #666666; font-size: 26px;"><b>¡INFORMACIÓN IMPORTANTE!&nbsp;</b></h2>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p30t es-p15b es-p20r es-p20l" align="center">
                                                                                        <p style="color: #242424;">Hola ${names}, el pedido con ID <span style="color:#000000;"><span style="background-color:#00FF00;"># ${id?.slice(
      0,
      8
    )}</span></span>&nbsp;que se te fue asignado&nbsp;ya cuenta con una tarifa de envío calculada, por tanto, debes cobrar al consumidor el siguiente valor de envío:<br><br><br><strong><span style="font-size: 24px; color: #ff8c00;">$${tariff} COP</span></strong></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p20t es-p25b es-p10r es-p10l" align="center"><span class="es-button-border" style="border-radius: 20px; border-style: solid; border-width: 0px; background: #058d38; border-color: #2cb543;"><a href="https://bdproyectospc.web.app/#/mis-ordenes" class="es-button es-button-1660706598669" target="_blank" style="border-radius: 20px; font-family: &quot;lucida sans unicode&quot;, &quot;lucida grande&quot;, sans-serif; font-weight: normal; border-width: 10px 35px; color: #ffffff; background: #058d38; border-color: #058d38; font-size: 16px;">Revisar pedidos asignados</a></span></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td width="600" class="esd-container-frame" align="center" valign="top">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img class="adapt-img" src="https://wjmjag.stripocdn.email/content/guids/CABINET_7216361002ae0f729c7c080bbf57ae0a/images/loslideresdelaindustriaalimentariaalertansobreelpeligroexistenteenladistribuciond.jpeg" alt style="display: block;" width="600"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                    ...
                                                                    <td class="esd-container-frame" width="560" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p20t es-p20b" esd-links-color="#ffffff" esd-links-underline="none" style="color: #ffffff;">
                                                                                        <p style="line-height: 120%; color: #cccccc; font-size: 14px;"><strong>Universidad de Cundinamarca<br>Laura Tatiana Ramos Villanueva & Johann Nicolás Nieto Cárdenas<br><a target="_blank" href="mailto:proyectospcudec@gmail.com" style="line-height: 120%; font-size: 14px; text-decoration: none; color: #cccccc;">proyectospcudec@gmail.com</a></strong></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t es-p10b" align="center">
...
export const notifyOrderDelivered = (user: User, orderId: string) => {
  const { names, lastnames } = user;
  return {
    from: '"Pedido entregado" <proyectospcudec@gmail.com>',
    subject: "¡El pedido ya ha sido entregado al consumidor! 🚚🍇🚨🍑",
    html: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office">
                                ...
                                <tr>
                                    <td class="esd-stripe" align="center">
                                        <table class="es-header-body" width="600" cellspacing="0" cellpadding="0" align="center" bgcolor="#f8f8f8" style="background-color: #f8f8f8;">
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p15" align="left" bgcolor="#EE731B" style="background-color: #ee731b;">
                                                        <table cellpadding="0" cellspacing="0" class="es-left" align="left">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="276" align="left" class="esd-container-frame es-m-p20b">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" class="es-right" align="right">
                                                            <tbody>
                                                                <tr>
                                                                    <td width="274" class="esd-container-frame" align="left">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="right" class="esd-block-text es-p10">
                                                                                        <p style="font-size: 20px; color: #ffffff; font-family: lato, 'helvetica neue', helvetica, arial, sans-serif; line-height: 200%;"><strong>${
                                                                                          names.toUpperCase() +
                                                                                          " " +
                                                                                          lastnames.toUpperCase()
                                                                                        }</strong></p>
                                                ...
                                                <tr>
                                                    <td class="esd-structure es-p20t es-p20b es-p20r es-p20l" esd-general-paddings-checked="false" style="background-color: #f8f8f8;" bgcolor="#f8f8f8" align="left">
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="560" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p30t es-p30b" align="center">
                                                                                        <div class="esd-text">
                                                                                            <h2 style="color: #242424; font-size: 30px;"><b>¡ATENCIÓN, PEDIDO ENTREGADO!</b></h2>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p30b es-p10l" align="center">
                                                                                        <p style="color: #242424; font-size: 15px;">Hola ${names}, queremos informarte que uno de tus pedidos con<br>ID <span style="background-color:#00FF00;">#${orderId.slice(
      0,
      8
    )}</span>&nbsp;acaba de ser entregado al domicilio del consumidor.<br>Te queremos dar las gracias por hacer parte de esta comunidad y queremos que continúes&nbsp;haciendo de tu trabajo, una verdadera experiencia del campo!!!</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                ...
                                                <tr>
                                                    <td class="esd-structure" style="background-color: #eeeeee;" esd-general-paddings-checked="false" bgcolor="#eeeeee" align="left">
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="600" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img class="adapt-img" src="https://wjmjag.stripocdn.email/content/guids/CABINET_00cfa3aee6d44ff5bfd1e0e7ddf92e26/images/producer.jpg" alt style="display: block;" width="600"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                ...
                                <tr>
                                    <td class="esd-stripe" align="center" esd-custom-block-id="88703">
                                        <table class="es-footer-body" width="600" cellspacing="0" cellpadding="0" align="center">
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p20" esd-general-paddings-checked="false" align="left" bgcolor="#058D38" style="background-color: #058d38;">
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-container-frame" width="560" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p20t es-p20b" esd-links-color="#ffffff" esd-links-underline="none" style="color: #ffffff;">
                                                                                        <p style="line-height: 120%; color: #ffffff; font-size: 14px;"><strong>Universidad de Cundinamarca<br>Laura Tatiana Ramos Villanueva & Johann Nicolás Nieto Cárdenas<br><a target="_blank" href="mailto:proyectospcudec@gmail.com" style="line-height: 120%; font-size: 14px; text-decoration: none;">proyectospcudec@gmail.com</a></strong></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10t es-p10b" align="center">
                                                                                        <p style="color: #999999; font-size: 25px;">NOS UNE EL AMOR POR EL&nbsp;<br><strong>CAMPO CUNDINAMARQUÉS</strong></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
